# МедПоиск - Медицинское приложение для поиска клиник и записи на прием

Современное веб-приложение для поиска медицинских клиник, записи на прием и получения медицинских услуг. Разработано с фокусом на мобильный UX и включает полный цикл записи к врачу.
...
2. **Страница поиска** (`/search`)
   ...
   - Карточки клиник с рейтингами и отзывами
