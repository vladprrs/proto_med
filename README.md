...
- **Фильтрация результатов** по рейтингу, цене, времени работы, специализации и дате приёма через выпадающие списки. В фильтре даты доступно значение «Любое» для сброса ограничения
