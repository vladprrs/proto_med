...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    ...
    if (savedAppointments) {
      try {
        ...
        dispatch({ type: ActionTypes.LOAD_FROM_STORAGE, payload: { appointments: parsedAppointments } })
      } catch (error) {
  ...
  const actions = {
    ...
    selectSpecialist: (specialist) => dispatch({ type: ActionTypes.SELECT_SPECIALIST, payload: specialist }),
    selectDateTime: (date, time) => dispatch({ type: ActionTypes.SELECT_DATE_TIME, payload: { date, time } }),
    ...
    setError: (field, error) => dispatch({ type: ActionTypes.SET_ERROR, payload: { field, error } }),
    ...
    // Active appointment
    setActiveAppointment: (appointment) => dispatch({ type: ActionTypes.SET_ACTIVE_APPOINTMENT, payload: appointment }),
    ...
    removeAppointment: (appointmentId) => dispatch({ type: ActionTypes.REMOVE_APPOINTMENT, payload: appointmentId }),
    ...
    // Modal actions
    toggleModal: (modal, isOpen) => dispatch({ type: ActionTypes.TOGGLE_MODAL, payload: { modal, isOpen } }),
    ...
    setSelectedServices: (services) => dispatch({ type: ActionTypes.SELECT_SERVICES, payload: services }),
    setSelectedSpecialist: (specialist) => dispatch({ type: ActionTypes.SELECT_SPECIALIST, payload: specialist }),
    setSelectedDateTime: (dateTime) => dispatch({ 
